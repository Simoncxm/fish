    ...
    <div class="echat-setGroup-contianer">
      <el-form ref="groupForm" label-width="65px" class="groupForm" :rules="groupRules" :model="groupForm">
        ...
        <el-form-item label="群简介" prop="groupDesc">
          <el-input v-model="groupForm.groupDesc" placeholder="请输入不超过200个字" type="textarea" aotusize resize="none"
                    :maxlength="200">
          </el-input>
        </el-form-item>
      </el-form>
      <button @click="setUp" class="echat-full-button">创建</button>
    </div>
    <el-dialog
